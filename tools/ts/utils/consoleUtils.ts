...
export function formatConsole(contents: string[], color?: undefined | 'white' | 'grey' | 'black' | 'blue' | 'cyan' | 'green' | 'magenta' | 'red' | 'yellow', style?: undefined | 'bold' | 'italic' | 'underline' | 'inverse' | 'strikethrough', colorBG?: undefined | 'whiteBG' | 'greyBG' | 'blackBG' | 'blueBG' | 'cyanBG' | 'greenBG' | 'magentaBG' | 'redBG' | 'yellowBG'): string {
